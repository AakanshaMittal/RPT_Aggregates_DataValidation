...
OUTPUT_RPT_APP_FOLDER = Path("Output_RPT_APP_Folder_Aggregates")
OUTPUT_RPT_EXC_FOLDER = Path("Output_RPT_Aggregate_RPT")
REPORT_OUTPUT_FOLDER = Path("Comparison_Reports")
